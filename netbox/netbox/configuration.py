...
ALLOWED_HOSTS = [os.getenv("NBX_ALLOWED_HOSTS")]

# PostgreSQL database configuration. See the Django documentation for a complete list of available parameters:
#   https://docs.djangoproject.com/en/stable/ref/settings/#databases
DATABASE = {
    'NAME': os.getenv("NBX_DATABASE_NAME"),         # Database name
    'USER': os.getenv("NBX_DATABASE_USERNAME"),               # PostgreSQL username
    'PASSWORD': os.getenv("NBX_DATABASE_PASSWORD"),           # PostgreSQL password
    'HOST': os.getenv("NBX_DATABASE_HOST"),      # Database server
    'PORT': int(os.getenv("NBX_DATABASE_PORT", '')),               # Database port (leave blank for default)
...
SECRET_KEY = os.getenv("NBX_SECRET_KEY")
...
SOCIAL_AUTH_AZUREAD_OAUTH2_KEY = os.getenv("NBX_APP_ID")
SOCIAL_AUTH_AZUREAD_OAUTH2_SECRET = os.getenv("NBX_APP_SECRET")
...
#    'AZURE_ACCOUNT_KEY': os.getenv("NBX_STORAGE_KEY"),
#    'AZURE_CONTAINER': os.getenv("NBX_STORAGE_CONTAINER")
#}
